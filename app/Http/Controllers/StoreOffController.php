...
class StoreOffController extends Controller
{
    private $data;
    private $column;
       public function __construct()
    {
        $this->data = StoreOff::all();
        $column  = DB::getSchemaBuilder()->getColumnListing('store_off');
  ...
  public function showPage(){
        ...
        return view("admin.pages.listStoreOff",['data'=>$this->data,'period'=>$period,'employee'=>$employee->where('active',1)]);
    }
  public function save(Request $request){
     ...
     public function export(){   
       Excel::create('ExcelFormImport', function ($excel) {
        ...
        $excel->sheet('StoreOff', function ($sheet) {
...
//            }
    ...
    public function import(Request $request){
          ...
          foreach($sheet as $sh){  
                ...
                $return -> save();
                $data[$count] = StoreOff::get_all($return->id); 
