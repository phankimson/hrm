...
class TimeKeeperController extends Controller
{
    ...
    {
        $this->data = TimeKeeper::all();
        $column  = DB::getSchemaBuilder()->getColumnListing('timekeeper');
        $this->column = array_diff($column, array("id"));
    }

  public function showPage(){
        return view("admin.pages.listTimeKeeper",['data'=>$this->data]);
    }
