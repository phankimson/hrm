...
class DepartmentController extends Controller
{
       ...
       public function __construct()
    {
        ...
        $column  = DB::getSchemaBuilder()->getColumnListing('department');
        $this->column = array_diff($column, array("id"));
    }

  public function showPage(){
        return view("admin.pages.listDepartment",['data'=>$this->data]);
    }
...
//            }
    ...
    public function import(Request $request){
          ...
          foreach($sheet as $sh){  
                ...
                $return -> save();
                $data[$count] = Department::get_all($return->id); 
