...
class TemplateController extends Controller
{
    ...
    {
        $this->data = Template::all();
        $column  = DB::getSchemaBuilder()->getColumnListing('template');
        $this->column = array_diff($column, array("id", "created_at","updated_at"));
    }

  public function showPage(){
        return view("admin.pages.listTemplate",['data'=>$this->data]);
    }
...
//            }
    ...
    public function import(Request $request){
          ...
          foreach($sheet as $sh){  
                ...
                $return -> save();
                $data[$count] = Template::get_all($return->id);  
