...
class PeriodController extends Controller
{
    ...
    {
        $this->data = Period::all();
        $column  = DB::getSchemaBuilder()->getColumnListing('period');
        $this->column = array_diff($column, array("id"));
    }

  public function showPage(){
        return view("admin.pages.listPeriod",['data'=>$this->data]);
    }
  public function save(Request $request){
     ...
     public function export(){   
       Excel::create('ExcelFormImport', function ($excel) {
        ...
        $excel->sheet('Period', function ($sheet) {
...
//            }
    ...
    public function import(Request $request){
          ...
          foreach($sheet as $sh){  
                ...
                $return -> save();
                $data[$count] = Period::get_all($return->id); 
