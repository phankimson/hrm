...
class HelpDeskController extends Controller
{
    ...
    {
        $this->data = HelpDesk::all();
        $column  = DB::getSchemaBuilder()->getColumnListing('help_desk');
        $this->column = array_diff($column, array("id", "created_at","updated_at"));
    }

  public function showPage(){
        return view("admin.pages.listHelpDesk",['data'=>$this->data]);
    }
  public function save(Request $request){
     ...
     public function export(){   
       Excel::create('ExcelFormImport', function ($excel) {
        ...
        $excel->sheet('HelpDesk', function ($sheet) {
...
//            }
    ...
    public function import(Request $request){
          ...
          foreach($sheet as $sh){  
                ...
                $return -> save();
                $data[$count] = HelpDesk::get_all($return->id);  
