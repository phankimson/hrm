var Login = function() {
     jQuery('input[name="username"],input[name="password"]').keypress(function (e) {
      ...
      var btnLogin = function(e){
        ...
        var postdata = {data : JSON.stringify(data)};  
            RequestURLWaiting('login','json',postdata,function(data){
                if(data.status == true){  
                    window.location.href = App.getHostPath();
                }else{
      ...
      var btnEmail = function(e){
         e.preventDefault();
        var data = GetAllValueForm('.forget-form input');
            var postdata = {data : JSON.stringify(data)}; 
    ...
    return {
        ...
        init: function() {
            ...
            $('.login-bg').backstretch([
                App.getHostPath()+'public/pages/img/login/bg1.jpg',
                App.getHostPath()+'public/pages/img/login/bg2.jpg',
                App.getHostPath()+'public/pages/img/login/bg3.jpg'
                ], {
                  fade: 1000,
                  duration: 8000
                }
