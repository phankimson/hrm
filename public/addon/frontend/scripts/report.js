  var EposReport = function () {  
      ...
      var obj = {};var arr = [];var crit = false;var url;
      ...
      var getColumn = function(){       
            var adata = '';
             ...
             jQuery('#data-crit input').each(function() {
                ...
                adata ={"type": "radio","name" : jQuery(this).attr('name')  ,"id": jQuery(this).attr('id'),"class": jQuery(this).attr('class')};        
                    }else{
        ...
        var initGetValue = function(){            
          jQuery.each(arr, function(k, v) {
                ...
                if(v.class.indexOf("select2me")>0){
                   ...
                   obj[v.name] = jQuery('input[name=radio]:checked', '#radio').val();    
                    }
                    else{
