...
@section('content')
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title tabbable-line">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-purple bold uppercase">{{trans('menu.overtime')}}</span>
                            </div> 
        ...
        jQuery(document).ready(function() {   
           ...
           Epos.url = <?= json_encode(['load_url'=>'get/overtime','delete_url'=>'update/overtime','save_url'=>'add/overtime']);?>;
        });  
        </script>         
