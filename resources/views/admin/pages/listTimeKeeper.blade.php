                                                        ...
                                                        <table class="table table-striped table-bordered table-hover order-column" style="border:none" id="grid">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th> {{trans('timekeeper.type')}}</th>
                                                                    <th> {{trans('timekeeper.code')}}</th>
                                                                    <th> {{trans('timekeeper.name')}}</th> 
                                                                    <th> {{trans('timekeeper.value')}}</th> 
                                                                    <th> {{trans('timekeeper.method')}}</th> 
                                        ...
                                        <div class="col-md-6">
                                            <div class="portlet">
                                                ...
                                                <div class="portlet-body" id='form-action'>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">{{trans('timekeeper.type')}} (*)</label>
                                                            <div class="col-sm-5">                       
                                                                      <select name="type" id="type" position="1" class="input-medium form-control select2me" data-placeholder="Select..."> 
                                                                        <option value=""></option>
                                                                        <option value="1">{{trans('timekeeper.date')}}</option>
                                                                        <option value="2">{{trans('timekeeper.time')}}</option> 
                                                                     </select>
                                                           </div>
                                                        </div>
                                                        <div class="tr-space"></div>
                                                        <div class="tr-space"></div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">{{trans('timekeeper.code')}} (*)</label>
                                                            <div class="col-sm-5">                       
                                                                        <input type="text" class="form-control input-large not-null" position="2" maxlength="50" name="code" id="maxlength_defaultconfig">
                                                           </div>
                                                        </div>
                                                        <div class="tr-space"></div>
                                                        <div class="tr-space"></div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">{{trans('timekeeper.name')}} (*)</label>
                                                            <div class="col-sm-5">                       
                                                                        <input type="text" class="form-control input-large not-null"  position="3" maxlength="100" name="name" id="maxlength_defaultconfig">
                                                           </div>
                                                        </div>   
                                                        ...
                                                        <div class="tr-space"></div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">{{trans('timekeeper.value')}}</label>
                                                             <div class="col-md-4">
                                                                     <input type="text" class="form-control input-medium"  position="4" maxlength="100" name="value" id="maxlength_defaultconfig">
                                                            </div>
                                                        </div> 
                                                         <div class="tr-space"></div>
                                                        <div class="tr-space"></div>
