...
@section('content')
                        ...
                        <div class='modal-content portlet box blue-hoki'>
                            ...
                            <div class="modal-body portlet-body" id="form-action">
                                            <table  class="table borderless" style="border-style: none">
                                                <tr>
                                                  <td class="col-xs-1"><label class="control-label">{{trans('template.name')}}</label></td>
                                                  <td class="col-md-2"><input type="text" class="form-control input-xlarge" position="1" maxlength="70" name="name" id="maxlength_defaultconfig"></td>     
                                                </tr>

                                                <tr>
          
                                                  <td class="col-xs-1"><label class="control-label">{{trans('template.code')}}</label></td>
                                                  <td class="col-md-2"><input type="text" class="form-control input-medium" position="2" maxlength="20" name="code" id="maxlength_defaultconfig"></td>     
                                                </tr>
                         
                                                <tr>
                               
                                                  <td class="col-xs-1"><label class="control-label">{{trans('template.subject')}}</label></td>
                                                  <td class="col-md-2"><input type="text" class="form-control input-xxlarge" position="3" maxlength="100" name="subject" id="maxlength_defaultconfig"></td>     
                                                </tr>
                                          
                                                <tr>
                                      
                                                  <td class="col-xs-1"><label class="control-label">{{trans('template.content')}}</label></td>
                                                ...
                                                <tr>
                                                  ...
                                                  <td class="col-md-4"><input type="checkbox" name="active" class="form-control make-switch" position="5" checked data-size="medium" data-handle-width="25" data-on-text="<i class='fa fa-check'></i>" data-off-text="<i class='fa fa-times'></i>"></td>     
                                                </tr> 
                                            </table>	          
                            </div> 
    ...
    <div class="modal fade" id="import" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  ...
                  <div class="portlet light bordered">
                                <div class="portlet-title tabbable-line">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-purple bold uppercase">{{trans('menu.admin/template')}}</span>
                                    </div>
                                    <div class="pull-right">
                                        ...
                                        <a class="btn default green-stripe print tooltips" data-original-title="Ctrl+Alt+P" data-placement="top" data-container="body"> <i class="fa fa-print"></i> {{trans('global.print')}} </a>
                                         <div class="btn-group">
        ...
        jQuery(document).ready(function() {   
           ...
           EposAdminModal.url = <?= json_encode(['save_url'=>'add/form-voucher','delete_url'=>'update/form-voucher','import_url'=>'import/form-voucher','print_url'=>'get/form-voucher']);?>;
        });   
        </script>
