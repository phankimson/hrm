...
@section('content')
                  ...
                  <div class="portlet light bordered">
                                <div class="portlet-title tabbable-line">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-purple bold uppercase">{{trans('menu.options')}}</span>
                                    </div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover order-column" style="border:none" id="grid">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th> {{trans('options.code')}}</th>
                                                                    <th> {{trans('options.name')}}</th> 
                                                                    <th> {{trans('options.value')}}</th> 
                                                                    <th> {{trans('options.value1')}}</th> 
                                                                    <th> {{trans('options.value2')}}</th> 
                                        ...
                                        <div class="col-md-6">
                                            <div class="portlet">
                                                ...
                                                <div class="portlet-body" id='form-action'>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">{{trans('options.code')}}</label>
                                                            <div class="col-sm-5">                       
                                                        ...
                                                        <div class="tr-space"></div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">{{trans('options.name')}}</label>
                                                            <div class="col-sm-5">                       
                                                        ...
                                                        <div class="tr-space"></div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">{{trans('options.value')}}</label>
                                                            <div class="col-sm-5">                       
                                                                        <input type="text" class="form-control input-large" maxlength="100" position="3"  name="value" id="maxlength_defaultconfig">
                                                           </div>
                                                        </div>
                                                        <div class="tr-space"></div>
                                                        <div class="tr-space"></div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">{{trans('options.value1')}}</label>
                                                            <div class="col-sm-5">                       
                                                                        <input type="text" class="form-control input-large" maxlength="100" position="4"  name="value1" id="maxlength_defaultconfig">
                                                           </div>                 
                                                        </div>
                                                         <div class="tr-space"></div>
                                                        <div class="tr-space"></div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">{{trans('options.value2')}}</label>
                                                            <div class="col-sm-5">                       
                                                                        <input type="text" class="form-control input-large" maxlength="100" position="5"  name="value2" id="maxlength_defaultconfig">
                                                           </div>                 
                                                        </div>
                                                        <div class="tr-space"></div>
                                                        <div class="tr-space"></div>
        ...
        jQuery(document).ready(function() {   
           ...
           EposAdmin.url = <?= json_encode(['save_url'=>'add/options','delete_url'=>'update/options','import_url'=>'import/options']);?>;
        });   
        </script>
