...
@section('content')
                                    ...
                                    <div class="modal-body">                                       
                                        ...
                                        <div class="tr-space"></div>
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-5">
                                                        <a class="btn default" href="{{url(session()->get('locale').'/'.session()->get('manage').'/export/format-voucher')}}" >{{trans('global.download')}}</a>
                                                    </div>
                                            </div>
                                        <div class="tr-space"></div>
                                        <div class="tr-space"></div>
                  ...
                  <div class="portlet light bordered">
                                <div class="portlet-title tabbable-line">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-purple bold uppercase">{{trans('menu.format-voucher')}}</span>
                                    </div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover order-column" style="border:none" id="grid">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>{{trans('format_voucher.code')}}</th> 
                                                                    <th>{{trans('format_voucher.name')}}</th> 
                                                                    <th>{{trans('format_voucher.start_char')}}</th>         
                                                                    <th>{{trans('format_voucher.value')}}</th>                                                                   
                                                                </tr>
                                                            </thead>
                                                            <tbody>                                                                                                                            
                                                            </tbody>
                                        ...
                                        <div class="col-md-6">
                                            <div class="portlet">
                                                ...
                                                <div class="portlet-body" id='form-action'>
                                                    ...
                                                    <div class="tr-space"></div>
                                                    <div class="form-group">
                                                        <label class="col-sm-4 control-label">{{trans('format_voucher.code')}}</label>
                                                        <div class="col-sm-5">                       
                                                                    <input type="text" class="form-control input-large not-null" position="1" maxlength="30" name="code" id="maxlength_defaultconfig">
                                                       </div>
                                                    </div>    
                                                    <div class="tr-space"></div>
                                                    <div class="tr-space"></div>
                                                    <div class="form-group">
                                                        <label class="col-sm-4 control-label">{{trans('format_voucher.name')}}</label>
                                                        <div class="col-sm-5">                       
                                                                    <input type="text" class="form-control input-large not-null" position="2" maxlength="50" name="name" id="maxlength_defaultconfig">
                                                       </div>
                                                    </div> 
                                                    <div class="tr-space"></div>
                                                    <div class="tr-space"></div>
                                                    <div class="form-group">
                                                        <label class="col-sm-4 control-label">{{trans('format_voucher.start_char')}}</label>
                                                        <div class="col-sm-5">
                                                        <input type="text" class="form-control input-small" position="3" maxlength="10" name="start_char" id="maxlength_defaultconfig">
                                                        </div>
                                                    </div>   
                                                    <div class="tr-space"></div>
                                                    <div class="tr-space"></div>
                                                    <div class="form-group">
                                                        <label class="col-sm-4 control-label">{{trans('format_voucher.value')}}</label>
                                                        <div class="col-sm-5">
                                                        <input type="text" class="form-control input-small" position="4" maxlength="50" name="value" id="maxlength_defaultconfig">
                                                        </div>
                                                    </div>                                                   
                                                </div>
                                            </div>
        ...
        jQuery(document).ready(function() {   
           ...
           EposAdmin.url = <?= json_encode(['save_url'=>'add/format-voucher','delete_url'=>'update/format-voucher','import_url'=>'import/format-voucher']);?>;
        });   
        </script>
