...
@section('content')
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover order-column" style="border:none" id="grid">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th> {{trans('department.staffing')}}</th> 
                                        ...
                                        <div class="col-md-6">
                                            <div class="portlet">
                                                ...
                                                <div class="portlet-body" id='form-action'>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">{{trans('department.code')}}</label>
                                                            <div class="col-sm-5">                       
                                                        ...
                                                        <div class="tr-space"></div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">{{trans('department.name')}}</label>
                                                            <div class="col-sm-5">                       
                                                        ...
                                                        <div class="tr-space"></div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">{{trans('department.staffing')}}</label>
                                                             <div class="col-md-4">
                                                                     <input type="text" class="form-control input-medium"  position="3" maxlength="100" name="staffing" id="maxlength_defaultconfig">
                                                            </div>
                                                        </div> 
                                                        <div class="tr-space"></div>
                                                        <div class="tr-space"></div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                    <input type="checkbox" name="active" class="form-control make-switch"  position="4" checked data-on-text="<i class='fa fa-check'></i>" data-off-text="<i class='fa fa-times'></i>"> 
                                                            </div>
                                                        </div> 
                                                    </div>
                                            </div>
        ...
        jQuery(document).ready(function() {   
           ...
           EposAdmin.url = <?= json_encode(['save_url'=>'add/department','delete_url'=>'update/department','import_url'=>'import/department']);?>;
        });   
        </script>
