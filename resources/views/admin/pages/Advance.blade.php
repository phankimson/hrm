...
@section('content')
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title tabbable-line">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-purple bold uppercase">{{trans('menu.advance')}}</span>
                            </div> 
        ...
        jQuery(document).ready(function() {   
           EposAdvance.permission = <?= json_encode(session()->get('permission'));?>; 
           EposAdvance.url = <?= json_encode(['load_url'=>'get/advance','delete_url'=>'update/advance','save_url'=>'add/advance']);?>;
        });  
        </script>         
