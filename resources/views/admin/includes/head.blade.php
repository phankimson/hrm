<html lang="en">
    ...
    <head>
        ...
        <link href="{{url('/public/layouts/layout/css/layout.min.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{url('/public/layouts/layout/css/themes/darkblue.min.css')}}" rel="stylesheet" type="text/css" id="style_color" />
        <link href="{{url('/public/layouts/layout/css/custom.min.css')}}" rel="stylesheet" type="text/css" />
        <!-- END THEME LAYOUT STYLES -->
        
        <link href="{{url('/public/addon/admin/css/customize.css')}}" rel="stylesheet" type="text/css" />
